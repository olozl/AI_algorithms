# -*- coding: utf-8 -*-
"""
Created on Mon Oct  30 17:52:41 2017
...
init = [[2, 8, 3], [1, 6, 4], [7, 'b', 5]]
rand.append(init)
init = [[2, 8, 3], [1, 6, 4], ['b', 7, 5]]
rand.append(init)
init = [[1, 2, 3], [7, 8, 4], ['b', 6, 5]]
rand.append(init)
init = [[1, 'b', 3], [8, 2, 4], [7, 6, 5]]
rand.append(init)
init = [[1, 2, 3], [8, 6, 4], [7, 'b', 5]]
rand.append(init)
...
def copy(p, p2):
  p2 = [[0 for x in range(3)] for y in range(3)]
  for i in range(3):
    for j in range(3):
      p2[i][j] = p[i][j]
  return p2
